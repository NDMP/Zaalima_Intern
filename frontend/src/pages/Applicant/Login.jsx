    ...
    <Box sx={{ minHeight: "100vh", bgcolor: "#F8FAFC", display: "flex", alignItems: "center", py: { xs: 4, md: 6 } }}>
      <Container maxWidth="sm">
        <Paper elevation={0} sx={{ p: { xs: 3, md: 5 }, borderRadius: 4, border: "1px solid #E2E8F0", boxShadow: "0 24px 70px rgba(15, 23, 42, 0.08)" }}>
          ...
          <Typography align="center" color="text.secondary" fontWeight={500}>Applicant login</Typography>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", gap: 1 }}>
            ...
            <RouterLink to="/applicant/register" style={{ color: "#2563EB", fontWeight: 700 }}>Create account</RouterLink>
          </Box>
        </Paper>
      </Container>
    </Box>
