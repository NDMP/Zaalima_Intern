...
export default function Hero() {
  return (
    <Box sx={{ pt: { xs: 10, md: 14 }, pb: { xs: 8, md: 14 }, overflow: 'hidden', background: '#F8FBFF' }}>
      <Container maxWidth="xl">
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 8, alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ flex: 1, maxWidth: 620 }}>
            ...
            <Typography variant="h6" color="text.secondary" sx={{ mb: 5, fontWeight: 400, lineHeight: 1.75, maxWidth: 640 }}>
              Streamline recruitment with AI-powered resume screening, intelligent ranking, and real-time hiring analytics — all in one platform.
            </Typography>
            
            <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', mb: 5, alignItems: 'center' }}>
              <Button
  component={Link}
  to="/choose-role"
  variant="contained"
          ...
          <Box sx={{ flex: 1, position: 'relative', width: '100%', display: 'flex', justifyContent: 'center' }}>
            <Box 
              sx={{ 
                ...
                bottom: -10,
                left: -10,
                background: 'radial-gradient(circle, rgba(37,99,235,0.14) 0%, rgba(255,255,255,0) 65%)',
                zIndex: 0,
                borderRadius: '32px',
              }}
            />
            <Paper 
              ...
              sx={{ 
                ...
                position: 'relative',
                zIndex: 1,
                boxShadow: '0 40px 120px -40px rgba(15, 23, 42, 0.35)',
